...
import { splitMembers } from '../../../data/collections'
...
export function CollectionCard({ collection, plugins, installedIds, onOpen }: {
  ...
  return (
    <button data-flip-key={`collection:${collection.id}`} className={cx('card', 'collection-card', fullyInstalled && 'installed')} onClick={onOpen} type="button">
