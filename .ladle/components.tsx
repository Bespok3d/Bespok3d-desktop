...
const catalogB3d = {
  ...
  printers: {
    adaptersList: () => Promise.resolve([makeAdapterInfo(), makeAdapterInfo({ id: 'voron-24', title: 'Voron 2.4', vendor: 'Voron Design', description: 'Stock Klipper adapter for a Voron 2.4.' })]),
